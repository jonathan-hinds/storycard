...
const phaseManager = new PhaseManagerClient({
  elements: {
    ...
    avatarPanelYInput: document.getElementById('phase-manager-avatar-panel-y-range'),
    avatarPanelYNumberInput: document.getElementById('phase-manager-avatar-panel-y-number'),
    avatarPanelYValueEl: document.getElementById('phase-manager-avatar-panel-y-value'),
    avatarPanelOpacityInput: document.getElementById('phase-manager-avatar-panel-opacity-range'),
    avatarPanelOpacityNumberInput: document.getElementById('phase-manager-avatar-panel-opacity-number'),
    avatarPanelOpacityValueEl: document.getElementById('phase-manager-avatar-panel-opacity-value'),
