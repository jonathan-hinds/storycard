...
const phaseManager = new PhaseManagerClient({
  elements: {
    ...
    tuningMobileUpDownEl: document.getElementById('phase-manager-tune-mobile-up-down'),
    tuningMobileUpDownValueEl: document.getElementById('phase-manager-tune-mobile-up-down-value'),
    tuningMobileLeftRightEl: document.getElementById('phase-manager-tune-mobile-left-right'),
    tuningMobileLeftRightValueEl: document.getElementById('phase-manager-tune-mobile-left-right-value'),
    tuningMobileNearFarEl: document.getElementById('phase-manager-tune-mobile-near-far'),
    tuningMobileNearFarValueEl: document.getElementById('phase-manager-tune-mobile-near-far-value'),
