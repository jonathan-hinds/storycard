...
const phaseManager = new PhaseManagerClient({
  elements: {
    ...
    upkeepCounterXInput: document.getElementById('phase-manager-upkeep-counter-x'),
    upkeepCounterYInput: document.getElementById('phase-manager-upkeep-counter-y'),
    upkeepCounterScaleInput: document.getElementById('phase-manager-upkeep-counter-scale'),
    ...
    upkeepCounterXValueEl: document.getElementById('phase-manager-upkeep-counter-x-value'),
    upkeepCounterYValueEl: document.getElementById('phase-manager-upkeep-counter-y-value'),
    upkeepCounterScaleValueEl: document.getElementById('phase-manager-upkeep-counter-scale-value'),
