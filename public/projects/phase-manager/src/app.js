...
const phaseManager = new PhaseManagerClient({
  elements: {
    ...
    upkeepTextSizeInput: document.getElementById('phase-manager-upkeep-text-size'),
    ...
    upkeepTextSizeValueEl: document.getElementById('phase-manager-upkeep-text-size-value'),
