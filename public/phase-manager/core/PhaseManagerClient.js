...
const DEFAULT_UPKEEP_PANEL_SIZE = { width: 1.58, height: 0.48 };
const DEFAULT_UPKEEP_POSITION = { x: 0.721, y: 0.102, z: -6 };
const DEFAULT_UPKEEP_TEXT_POSITION = { x: -0.02, y: -0.03 };
const DEFAULT_UPKEEP_TEXT_SCALE = 0.5;
const DEFAULT_UPKEEP_BACKGROUND_ASSET_PATH = '/public/assets/button1.png';
